...
curl -fsSL -o xui_cf_deployer.py https://github.com/dlinerli/xui-cf-deployer/blob/main/xui_cf_deployer.py
...
```bash
command -v python3 >/dev/null 2>&1 || (sudo apt update && sudo apt install -y python3)
curl -fsSL -o xui_cf_deployer.py [https://raw.githubusercontent.com/byJoey/xui-cf-deployer/main/xui_cf_deployer.py](https://github.com/dlinerli/xui-cf-deployer/blob/main/xui_cf_deployer.py)
chmod +x xui_cf_deployer.py
